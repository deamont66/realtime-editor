...
% TODO: diagramy komunikace s jednotlivými druhy zpráv
...
V této sekci je obsažen kompletní výpis druhů zpráv zasílaných mezi klientem a serverem.
...
Tato zpráva existuje ve dvou variantách, jedna pro prvotní připojení a druhá pro případ opakovaného připojení po obnovení přerušeného spojení.
...
Součástí zprávy Chyba je stavový kód chyby, který může nabývat hodnot 404 (dokument nebyl nalezen nebo k němu nemá uživatel oprávnění) a 403 (uživatel provedl operaci, ke které neměl dostatečné oprávnění).

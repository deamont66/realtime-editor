...
% TODO: abstrakt
\abstractCS{Tato bakalářská práce se věnuje návrhu a~implementaci nástroje umožňující kolaborativní editaci textů ve skutečném čase.
Rešeršní část práce se nejprve zabývá analýzou požadavků takového nástroje.
Dále jsou představeny použitelné technologie a~algoritmy, které tyto požadavky splňují.
